...
df =   df[(df['Channel_Name'] == 'Aaj Tak') | (df['Channel_Name'] == 'Good_News_Today') | (df['Channel_Name'] == 'India_TV') | (df['Channel_Name'] == 'Republic_Bharat')
       |(df['Channel_Name'] == 'News 24') |(df['Channel_Name'] == 'News18_India') |(df['Channel_Name'] == 'Zee_News') |(df['Channel_Name'] == 'TV9_Bharatvarsh') |
       (df['Channel_Name'] == 'ABP_News') |(df['Channel_Name'] == 'Times_Now_Navbharat')
       |(df['Channel_Name'] == 'India_Today_TV') | (df['Channel_Name'] == 'CNN_News18') |(df['Channel_Name'] == 'Republic_24x7') 
       |(df['Channel_Name'] == 'NDTV_24x7') |(df['Channel_Name'] == 'WION')]
tmp = df
...
df3 = final_df1.resample('60T').mean(numeric_only=True).astype(int)
...
df9 = df9.resample('1440T').mean(numeric_only=True).astype(int)
...
df3 = final_df1.resample('30T').mean(numeric_only=True).astype(int)
...
df11 = df11.resample('1440T').mean(numeric_only=True).astype(int)
...
| (df3['Time'].astype(str) == '21:00:00') | (df3['Time'].astype(str) == '20:00:00')]
...
df7 = df3[(df3['Time'].astype(str) == '14:00:00') | (df3['Time'].astype(str) == '22:00:00') |
              (df3['Time'].astype(str) == '14:30:00') | (df3['Time'].astype(str) == '22:30:00')]
...
Slot_Anchor = ['Neha Batham','Arpita Arya','Neha / Arpita','Neha Batham',
            'Sayeed / Neha / Rajeev','Sayeed / Rajeev / Arpita / Ashutosh','Sweta Singh',
            'Gaurav Sawant','Sahil Joshi','Anjana Om Kashyap','Arpita Arya / Neha Batham',
            'Arpita Arya / Neha Batham','Sweta Singh','Sweta Singh','Sweta Singh','Anjana Om Kashyap','Sayeed Ansari','']
...
final_hindi = pd.concat([final_hindi,df9])
...
final_english = pd.concat([final_english,df11])
 
l=[0,1,2,3,5,4,6,7,8] # index order
final_english=final_english[[final_english.columns[i] for i in l]]
final_hindi.to_excel('All_Hindi.xlsx')

numeric_columns = final_hindi.select_dtypes(include=['number'])
final_hindi["Sum"] = numeric_columns.sum(axis=1)
...
#result = (final_hindi.loc[:,"Aaj Tak":"Times_Now_Navbharat"].div(final_hindi["Sum"], axis=0)*100).round(1).astype(str) + '%'
...
final_hindi.to_excel(writer, index = False, sheet_name='1_File')
# final_hindi.to_excel(writer, encoding='utf-8-sig', index = False, sheet_name='1_File')
result.to_excel(writer, index = False, sheet_name='2_File')
...
Slot_Anchor = ['Aishwarya Paliwal','Aishwarya Paliwal','Pooja Shali','Pooja Shali','Sneha Mordani',
        'Pooja Shali','Sneha Mordani','Aneesha Mathur','Aneesha Mathur','Sneha Mordani',
        'Sneha Mordani','Pooja Shali','Akshita Nandgopal','Preeti Choudhary','Gaurav Sawant',
        'Rajdeep Sardesai','Akshita Nandgopal','Geeta Mohan','']
final_english.to_excel('All_English.xlsx')

numeric_columns = final_english.select_dtypes(include=['number'])
final_english["Sum"] = numeric_columns.sum(axis=1)
...
final_english.to_excel(writer,  index = False, sheet_name='3_File')
# final_english.to_excel(writer, encoding='utf-8-sig', index = False, sheet_name='3_File')
result.to_excel(writer,  index = False, sheet_name='4_File')
...
# result = greenAPI.sending.sendFileByUpload('120363179112115004@g.us',
#     "Combined_eng.png",
#     'Combined_eng.png', "YT Anchor Wise Reports | Avg Concurrent Users | Market Share % | English News Channels | " + str(today))
# print(result.data)
...
# ################## Individual Message ##################
# #VM
# result = greenAPI.sending.sendFileByUpload('919654985566@c.us',
#     "Combined_hindi.png",
#     'Combined_hindi.png', "YT Anchor Wise Reports | Avg Concurrent Users | Market Share % | Hindi News Channels | " + str(today))
# print(result.data)
...
# #KP
# result = greenAPI.sending.sendFileByUpload('919810011123@c.us',
#     "Combined_hindi.png",
#     'Combined_hindi.png', "YT Anchor Wise Reports | Avg Concurrent Users | Market Share % | Hindi News Channels | " + str(today))
# print(result.data)
...
# print(result.data)
# #SP
# result = greenAPI.sending.sendFileByUpload('919899444456@c.us',
#     "Combined_hindi.png",
#     'Combined_hindi.png', "YT Anchor Wise Reports | Avg Concurrent Users | Market Share % | Hindi News Channels | " + str(today))
# print(result.data)
...
# print(result.data)
# #MK
# result = greenAPI.sending.sendFileByUpload('919899887326@c.us',
#     "Combined_hindi.png",
#     'Combined_hindi.png', "YT Anchor Wise Reports | Avg Concurrent Users | Market Share % | Hindi News Channels | " + str(today))
# print(result.data)
...
# print(result.data)
# #VP
# result = greenAPI.sending.sendFileByUpload('918587830400@c.us',
#     "Combined_hindi.png",
#     'Combined_hindi.png', "YT Anchor Wise Reports | Avg Concurrent Users | Market Share % | Hindi News Channels | " + str(today))
# print(result.data)
...
# print(result.data)
# #VG
# result = greenAPI.sending.sendFileByUpload('918800850300@c.us',
#     "Combined_hindi.png",
#     'Combined_hindi.png', "YT Anchor Wise Reports | Avg Concurrent Users | Market Share % | Hindi News Channels | " + str(today))
# print(result.data)
