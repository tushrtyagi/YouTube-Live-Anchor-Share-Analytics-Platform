...
def arr(lang):
    ...
    if language == "English":
        ...
        all_csv = glob.glob(src_path+"/*.xlsx")
    if language == "Hindi":
...
SLOTS IN :
SPECIAL REPORT  	                >>>  20:00 - 21:00
BLACK & WHITE	                    >>>  21:00 - 22:00
CHUNAV AT LOC SHWETA SINGH KE SAATH	>>>  19:00 - 20:00
...
'''
                ...
                result = greenAPI.sending.sendMessage(
                    '918178139556@c.us', text1)  # ITGGROUP
